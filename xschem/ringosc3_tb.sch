...
C {devices/code_shown.sym} 80 -40 0 0 {name=spice only_toplevel=false value=".option wnflag=0
.option savecurrents
.control
save all
tran 1ps 10ns
...
.endc
"}
C {sky130_fd_pr/corner.sym} 70 -190 0 0 {name=CORNER only_toplevel=false corner=tt}
C {/home/fauzann/latiahan1/xschem/ringosc3_i.sym} -210 -100 0 0 {name=x1}
